...
//============================================================================//
  ...
  for (Long64_t i=0;i<nentries;i++){
    ...
    if(pass_ccqe_numu_sample(ana_struct) == true){
      ...
      if(ana_struct.is_rad == 0){
        ...
        h_passccnumu_radcont_Enu_totw->Fill(nu_en_corr, ana_struct.w_osc * ana_struct.w_rad);
  ...
  plot_hist1D(h_passccnumu_radcont_Enu_totw,"h_passccnumu_radcont_Enu_totw",  "Events (radiative + non-radiative) passing the CC#nu_{#mu} Selection (total weights);E_{#nu} [MeV];count", kBlue , 2, 1);  
