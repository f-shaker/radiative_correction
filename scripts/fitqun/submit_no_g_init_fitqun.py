...
def create_submission_script(file_idx):
    submission_file_fitqun = "submit_fitqun_no_g_init" + str(file_idx) + ".sh"
    input_skdetsim_file = "../skdetsim/skdetsim_output/skdetsim_out_no_g_init" + str(file_idx) + ".zbs"
    output_fitqun_file = "./fitqun_output/fitqun_out_no_g_init" + str(file_idx) + ".zbs"
...
for i in range(nb_files):
    dump = "fitqun_dump_no_g_init" + str(i) + ".txt"
