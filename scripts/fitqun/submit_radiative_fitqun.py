...
def create_submission_script(file_idx):
    submission_file_fitqun = "submit_fitqun_" + str(file_idx) + ".sh"
    input_skdetsim_file = "../skdetsim/skdetsim_output/skdetsim_out_" + str(file_idx) + ".zbs"
    output_fitqun_file = "./fitqun_output/fitqun_out_" + str(file_idx) + ".zbs"
